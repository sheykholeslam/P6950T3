...
GDD_Plot.png : ./source/extract_data_from_csv.py ./source/gdd_plot.py GDD_Data.csv
	python3 ./source/gdd_plot.py
	
min_max_plot.png : ./source/extract_data_from_csv.py ./source/min_max_plot.py GDD_Data.csv
