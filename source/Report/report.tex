...
{\Large Mohammad Hassan \\ Ernest Awoonor-Williams \\ Mehrzad \\ Yin Zhang \\ Rufai raji \\ Lutfor Rahman \\ Mohammad S.\par}
\vfill
...
\item  Plots showing annual cycle of min/max daily temperatures for selected Canadian cities
...
\item  Plots showing accumulated GDD versus time for selected cities
...
\begin{enumerate}
\item A bokeh plot showing GDD for selected Canadian cities considered
...
\item Exploration of how GDD calculation depends on the choice of $T_{base}$
\item A standalone bokeh plots embeded in our HTML presentation for interactive selection of data by interested users
\item A bokeh server plot for visualization of accumulated GDD for any city in Canada
